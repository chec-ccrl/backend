     ...
     ${abj2}
      ...
      <html>
        <body>
          ...
          <div class="main" style="height: 1670px">
            <!-- FIFTH PAGE -->
            ...
            <div class="main_page3_second">
              <div class="main_page3_second_one">
                <div class="main_page3_first_one_txt1" style="font-size:30px">RANKING</div>
      ...
      const htmlContent = [
        ...
        <html>
          ...
          Number(year) - 3
            ...
            const chart14 = new Chart(main_page4_first_one_one_main_one_chart14, {
              type: "pie",
              data: {
                labels:["0B:${apaUnitsAdded[0]}", "1B:${
          apaUnitsAdded[1]
        }", "2B:${apaUnitsAdded[2]}", "3B+:${apaUnitsAdded[3]}"],
                datasets: [
                  {
                    data: [${apaUnitsAdded}],
                    backgroundColor: ["#683733", "#8f7e18", "#5e6043", "#4c3848"],
        ...
        `<!DOCTYPE html>
          ...
          <html>
           ...
           <script>
              ...
              const chart9 = new Chart(main_page4_first_one_one_main_one_chart9, {
                type: "pie",
                data: {
                  labels: ["0B:${apaUnitsAva[0]}", "1B:${
          apaUnitsAva[1]
        }", "2B:${apaUnitsAva[2]}", "3B+:${apaUnitsAva[3]}"],
                  datasets: [
                    {
                      data: [${apaUnitsAva}],
                      backgroundColor: ["#683733", "#8f7e18", "#5e6043", "#4c3848"],
              ...
              const chart11 = new Chart(main_page4_first_one_one_main_one_chart11, {
                type: "pie",
                data: {
                  labels: ["0B:${rowUnitsAva[0]}", "1B:${
          rowUnitsAva[1]
        }", "2B:${rowUnitsAva[2]}", "3B+:${rowUnitsAva[3]}"],
                  datasets: [
                    {
                      data: [${rowUnitsAva}],
                      backgroundColor: ["#683733", "#8f7e18", "#5e6043", "#4c3848"],
          ...
          graph_4_1_cma[6]
                    ...
                    {
                      label: "Province", // Dataset label
                      data: [${graph_4_1_province[4]} ,${
          graph_4_1_province[5]
        },${graph_4_1_province[6]},${graph_4_1_province[7]}],
                      backgroundColor: "#5e6043", // Bar background color
                      borderColor: "#5e6043", // Bar border color
                      borderWidth: 2, // Bar border width
                    },
          ...
          graph_4_1_cma[2]
                    ...
                    {
                      label: "Province", // Dataset label
                      data: [${graph_4_1_province[0]} ,${
          graph_4_1_province[1]
        },${graph_4_1_province[2]},${graph_4_1_province[3]}],
                      backgroundColor: "#5e6043", // Bar background color
                      borderColor: "#5e6043", // Bar border color
                      borderWidth: 2, // Bar border width
                    },
          ...
          graph_4_3_affordable[graph_4_3_abbr[9]]
                    ...
                    },
                    {
                      label: "CMA", // Dataset label
                      data: [${
                        graph_4_3_average_rent_apa[graph_4_3_abbr[0]]
                      } ,${graph_4_3_average_rent_apa[graph_4_3_abbr[1]]} , ${
          graph_4_3_average_rent_apa[graph_4_3_abbr[2]]
        } , ${graph_4_3_average_rent_apa[graph_4_3_abbr[3]]} , ${
          graph_4_3_average_rent_apa[graph_4_3_abbr[4]]
          ...
          graph_4_3_average_rent_apa[graph_4_3_abbr[8]]
        } , ${graph_4_3_average_rent_apa[graph_4_3_abbr[9]]}], // Data values
                      backgroundColor: "#4c3848", // Bar background color
                      borderColor: "#4c3848", // Bar border color
                      // borderWidth: 1, // Bar border width
                    },
          ...
          graph_4_3_affordable[graph_4_3_abbr[9]]
                    ...
                    },
                    {
                      label: "CMA", // Dataset label
                      data: [${
                        graph_4_3_average_rent_row[graph_4_3_abbr[0]]
                      } ,${graph_4_3_average_rent_row[graph_4_3_abbr[1]]} , ${
          graph_4_3_average_rent_row[graph_4_3_abbr[2]]
        } , ${graph_4_3_average_rent_row[graph_4_3_abbr[3]]} , ${
          graph_4_3_average_rent_row[graph_4_3_abbr[4]]
          ...
          graph_4_3_average_rent_row[graph_4_3_abbr[8]]
        } , ${graph_4_3_average_rent_row[graph_4_3_abbr[9]]}], // Data values
                      backgroundColor: "#4c3848", // Bar background color
                      borderColor: "#4c3848", // Bar border color
                      // borderWidth: 1, // Bar border width
                    },
