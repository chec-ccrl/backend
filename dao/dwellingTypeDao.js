...
module.exports = {
  ...
  getAll: async (dwellingObj, transaction) => {
    try {
      ...
      let sql = `SELECT id , count(*) over() as "total_count" from "dwellingTypes" where province ilike :province order by "createdAt" desc , "row_house" desc limit :limit offset :offset`;
