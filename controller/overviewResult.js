  ...
  result: async (req, res, next) => {
    try {
            ...
            rentDetails.map(async (obj) => {
              ...
              if (
                ...
                all_outcome.push({
                  ...
                  optimal_income_before_tax: Number((rent * 12) / 0.3).toFixed(
                    0
                  ),
                });
              }
      ...
      all_outcome.sort((a, b) => {
        const nameA = a.province.toUpperCase(); // Ignore case for comparison
        const nameB = b.province.toUpperCase(); // Ignore case for comparison
        if (nameA < nameB) {
          return -1;
        }
        if (nameA > nameB) {
